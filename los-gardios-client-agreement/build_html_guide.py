...
# ==================================================================
# 1.3 — Proprietary technology (Neuron OS / Neuron Network, general)
# ==================================================================
...
<div class="secrule"></div>
<p class="body-copy">חלק מהיכולת שלנו לתאם מחקר, ניתוח, אסטרטגיה, הפקה וביצוע בו-זמנית, עבור לקוחות מרובים, נשען על מערכות טכנולוגיה פנימיות שפיתחנו ומחזיקים — <strong>מערכות Neuron</strong>: Neuron OS, מערכת ההפעלה הארגונית; ומודלים אלגוריתמיים קנייניים המכונים נוירונים (Neuron), הפועלים בתוכה.</p>
<div class="cardgrid grid2">
  ...
  <div class="card"><div class="card-label">{_neuron_icon_net}</div><div class="card-title">Neuron</div><p>מודלים אלגוריתמיים קנייניים הפועלים בתוך Neuron OS.</p></div>
</div>
<p class="body-copy">מעבר לצוות המומחים שלנו, מפתח הארגון מודלים אלגוריתמיים קנייניים המכונים <strong>נוירונים</strong> (Neuron). כל נוירון בנוי לזהות את הדפוסים שמאחורי הנתונים: מיפוי הזדמנויות, חיזוי תוצאות, ותרגום אותות לכדי החלטות ברורות בזמן אמת. ברגע שמודל מגיע לרמת ביטחון ביצוע גבוהה, ניתן להפוך תהליך נתון לאוטומטי — אך המערכת עובדת כי אנשים עובדים: האלגוריתמים פועלים לצד צוות גלובלי של אסטרטגים, אנליסטים ואנשי קריאייטיב שמביאים שיקול דעת, חוש נרטיבי וטעם, וקובעים מתי ואיך תהליך עובר לאוטומציה.</p>

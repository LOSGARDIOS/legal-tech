...
<p class="body-copy">Neuron Network הם המודלים הקנייניים של הארגון בתחומי הקריאייטיב, השיווק והבינה העסקית (BI) — פועלים בתיאום ומעבירים ביניהם תובנות אופטימיזציה, כמעין רשת נוירולוגית אחת. <strong>לפי חזון הארגון, זוהי הרשת הנוירולוגית הראשונה מסוגה בעולם המבוססת על בינה מלאכותית.</strong></p>

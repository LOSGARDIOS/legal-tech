...
<div class="cardgrid grid2">
  ...
  <div class="card"><div class="card-label">{_neuron_icon_net}</div><div class="card-title">Neuron Network</div><p>שכבת הבינה המלאכותית הקניינית הפועלת בתוך Neuron OS.</p></div>
</div>
<p class="body-copy">Neuron Network היא הרשת האינטליגנטית הקניינית של הארגון — מודלים ואלגוריתמים ייעודיים בתחומי הקריאייטיב, השיווק והבינה העסקית (BI), הפועלים בהרמוניה זה עם זה, שואבים כמויות גדולות של נתונים, ומייעלים פעילות עסקית בקנה-מידה תוך העברת תובנות אופטימיזציה זה לזה, כמעין מערכת נוירולוגית אחת. <strong>לפי חזון הארגון, זוהי הרשת הנוירולוגית הראשונה מסוגה בעולם המבוססת על בינה מלאכותית.</strong></p>
